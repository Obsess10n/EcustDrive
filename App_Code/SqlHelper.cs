...
public abstract class SqlHelper
{
    ...
    #region//ExecuteDataSet方法，大量数据用得到，返回dataset
    ...
    #region // ExecuteScalar方法，返回第一行的第一列，较少用
    /// <summary>
    /// 返回第一行的第一列
    /// </summary>
    /// <param name="cmdType">SqlCommand命令类型 (存储过程， T-SQL语句， 等等。)</param>
